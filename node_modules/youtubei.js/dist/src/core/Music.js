...
class Music {
    ...
    getUpNext(video_id, automix = true) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tabs = data.contents_memo.getType(Tab_1.default);
    ...
    getRelated(video_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const shelves = page.contents.item().as(SectionList_1.default).contents.as(MusicCarouselShelf_1.default, MusicDescriptionShelf_1.default);
            return shelves;
        });
    }
    /**
    ...
    getLyrics(video_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const section_list = page.contents.item().as(SectionList_1.default).contents;
