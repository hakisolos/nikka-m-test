...
class GridVideo extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.duration = data.lengthText ? new Text_1.default(data.lengthText) : (length_alt === null || length_alt === void 0 ? void 0 : length_alt.text) ? new Text_1.default(length_alt.text) : null;
