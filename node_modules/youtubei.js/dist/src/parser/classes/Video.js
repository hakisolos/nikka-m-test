...
class Video extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.expandable_metadata = __1.default.parseItem(data.expandableMetadata);
        this.thumbnails = Thumbnail_1.default.fromResponse(data.thumbnail);
        this.thumbnail_overlays = __1.default.parseArray(data.thumbnailOverlays);
        this.rich_thumbnail = data.richThumbnail ? __1.default.parseItem(data.richThumbnail) : null;
        ...
        this.menu = __1.default.parseItem(data.menu, Menu_1.default);
