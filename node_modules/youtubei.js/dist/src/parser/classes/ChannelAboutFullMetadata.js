...
class ChannelAboutFullMetadata extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.primary_links = data.primaryLinks.map((link) => ({
            endpoint: new NavigationEndpoint_1.default(link.navigationEndpoint),
            icon: Thumbnail_1.default.fromResponse(link.icon),
            title: new Text_1.default(link.title)
        }));
        ...
        this.buttons = index_1.default.parseArray(data.actionButtons);
    }
}
