...
const LiveChatActionPanel_1 = __importDefault(require("./LiveChatActionPanel"));
class ShowLiveChatActionPanelAction extends helpers_1.YTNode {
    constructor(data) {
        super();
        this.panel_to_show = index_1.default.parseItem(data.panelToShow, LiveChatActionPanel_1.default);
    }
}
