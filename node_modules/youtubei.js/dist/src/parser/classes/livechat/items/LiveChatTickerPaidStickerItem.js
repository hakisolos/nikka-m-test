...
class LiveChatTickerPaidStickerItem extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.show_item = index_1.default.parseItem((_b = (_a = data.showItemEndpoint) === null || _a === void 0 ? void 0 : _a.showLiveChatItemEndpoint) === null || _b === void 0 ? void 0 : _b.renderer);
