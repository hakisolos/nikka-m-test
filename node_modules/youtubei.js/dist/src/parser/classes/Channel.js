...
class Channel extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.long_byline = new Text_1.default(data.longBylineText);
        this.short_byline = new Text_1.default(data.shortBylineText);
        this.endpoint = new NavigationEndpoint_1.default(data.navigationEndpoint);
        this.subscribe_button = __1.default.parseItem(data.subscribeButton);
