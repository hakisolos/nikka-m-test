...
class Comment extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.sponsor_comment_badge = index_1.default.parseItem(data.sponsorCommentBadge);
        this.paid_comment_chip = index_1.default.parseItem(data.paidCommentChipRenderer);
        ...
        this.action_menu = index_1.default.parseItem(data.actionMenu);
        this.action_buttons = index_1.default.parseItem(data.actionButtons);
        this.comment_id = data.commentId;
        this.vote_status = data.voteStatus;
        this.vote_count = data.voteCount ? new Text_1.default(data.voteCount).toString() : '0';
    ...
    like() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!button)
                throw new Utils_1.InnertubeError('Like button was not found.', { comment_id: this.comment_id });
    ...
    dislike() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!button)
                throw new Utils_1.InnertubeError('Dislike button was not found.', { comment_id: this.comment_id });
            if (button.is_toggled)
    ...
    reply(text) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dialog_button = dialog.item().as(CommentReplyDialog_1.default).reply_button;
            if (!dialog_button)
                throw new Utils_1.InnertubeError('Reply button was not found in the dialog.', { comment_id: this.comment_id });
            if (!dialog_button.endpoint)
                throw new Utils_1.InnertubeError('Reply button endpoint was not found.', { comment_id: this.comment_id });
