...
class CommentThread extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.comment_replies_data = index_1.default.parseItem(data.replies);
    ...
    getReplies() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!__classPrivateFieldGet(this, _CommentThread_actions, "f"))
                throw new Utils_1.InnertubeError('Actions instance not set for this thread.');
            ...
            const continuation = (_b = this.comment_replies_data.contents) === null || _b === void 0 ? void 0 : _b.firstOfType(ContinuationItem_1.default);
            if (!continuation)
                throw new Utils_1.InnertubeError('Replies continuation not found.');
            const response = yield continuation.endpoint.call(__classPrivateFieldGet(this, _CommentThread_actions, "f"), { parse: true });
            this.replies = (0, helpers_1.observe)((_c = response.on_response_received_endpoints_memo) === null || _c === void 0 ? void 0 : _c.getType(Comment_1.default).map((comment) => {
                comment.setActions(__classPrivateFieldGet(this, _CommentThread_actions, "f"));
                return comment;
            }));
            __classPrivateFieldSet(this, _CommentThread_continuation, response === null || response === void 0 ? void 0 : response.on_response_received_endpoints_memo.getType(ContinuationItem_1.default).first(), "f");
            return this;
        });
    }
    /**
    ...
    getContinuation() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.replies)
                throw new Utils_1.InnertubeError('Cannot retrieve continuation because this thread\'s replies have not been loaded.');
            if (!__classPrivateFieldGet(this, _CommentThread_continuation, "f"))
                throw new Utils_1.InnertubeError('Continuation not found.');
            if (!__classPrivateFieldGet(this, _CommentThread_actions, "f"))
                throw new Utils_1.InnertubeError('Actions instance not set for this thread.');
            const load_more_button = (_a = __classPrivateFieldGet(this, _CommentThread_continuation, "f").button) === null || _a === void 0 ? void 0 : _a.as(Button_1.default);
            if (!load_more_button)
                throw new Utils_1.InnertubeError('"Load more" button not found.');
            const response = yield load_more_button.endpoint.call(__classPrivateFieldGet(this, _CommentThread_actions, "f"), { parse: true });
            this.replies = (0, helpers_1.observe)(response === null || response === void 0 ? void 0 : response.on_response_received_endpoints_memo.getType(Comment_1.default).map((comment) => {
                comment.setActions(__classPrivateFieldGet(this, _CommentThread_actions, "f"));
                return comment;
            }));
    ...
    get has_continuation() {
        if (!this.replies)
            throw new Utils_1.InnertubeError('Cannot determine if there is a continuation because this thread\'s replies have not been loaded.');
