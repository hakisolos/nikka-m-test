...
const CommentDialog_1 = __importDefault(require("./classes/comments/CommentDialog"));
...
const CreatorHeart_1 = __importDefault(require("./classes/comments/CreatorHeart"));
const EmojiPicker_1 = __importDefault(require("./classes/comments/EmojiPicker"));
const PdgCommentChip_1 = __importDefault(require("./classes/comments/PdgCommentChip"));
const SponsorCommentBadge_1 = __importDefault(require("./classes/comments/SponsorCommentBadge"));
...
const DecoratedPlayerBar_1 = __importDefault(require("./classes/DecoratedPlayerBar"));
...
const EmojiPickerCategory_1 = __importDefault(require("./classes/EmojiPickerCategory"));
const EmojiPickerCategoryButton_1 = __importDefault(require("./classes/EmojiPickerCategoryButton"));
const EmojiPickerUpsellCategory_1 = __importDefault(require("./classes/EmojiPickerUpsellCategory"));
...
const ExpandableMetadata_1 = __importDefault(require("./classes/ExpandableMetadata"));
...
const Heatmap_1 = __importDefault(require("./classes/Heatmap"));
const HeatMarker_1 = __importDefault(require("./classes/HeatMarker"));
...
const DimChatItemAction_1 = __importDefault(require("./classes/livechat/DimChatItemAction"));
...
const LiveChatRestrictedParticipation_1 = __importDefault(require("./classes/livechat/items/LiveChatRestrictedParticipation"));
...
const ShowLiveChatDialogAction_1 = __importDefault(require("./classes/livechat/ShowLiveChatDialogAction"));
...
const MacroMarkersListItem_1 = __importDefault(require("./classes/MacroMarkersListItem"));
...
const MultiMarkersPlayerBar_1 = __importDefault(require("./classes/MultiMarkersPlayerBar"));
...
const TimedMarkerDecoration_1 = __importDefault(require("./classes/TimedMarkerDecoration"));
...
const UpsellDialog_1 = __importDefault(require("./classes/UpsellDialog"));
...
exports.YTNodes = {
    ...
    CommentDialog: CommentDialog_1.default,
    ...
    CreatorHeart: CreatorHeart_1.default,
    EmojiPicker: EmojiPicker_1.default,
    PdgCommentChip: PdgCommentChip_1.default,
    SponsorCommentBadge: SponsorCommentBadge_1.default,
    ...
    DecoratedPlayerBar: DecoratedPlayerBar_1.default,
    ...
    EmojiPickerCategory: EmojiPickerCategory_1.default,
    EmojiPickerCategoryButton: EmojiPickerCategoryButton_1.default,
    EmojiPickerUpsellCategory: EmojiPickerUpsellCategory_1.default,
    ...
    ExpandableMetadata: ExpandableMetadata_1.default,
    ...
    HeatMarker: HeatMarker_1.default,
    ...
    DimChatItemAction: DimChatItemAction_1.default,
    ...
    LiveChatRestrictedParticipation: LiveChatRestrictedParticipation_1.default,
    ...
    ShowLiveChatDialogAction: ShowLiveChatDialogAction_1.default,
    ...
    MacroMarkersListItem: MacroMarkersListItem_1.default,
    Menu: Menu_1.default,
    ...
    MultiMarkersPlayerBar: MultiMarkersPlayerBar_1.default,
    ...
    TimedMarkerDecoration: TimedMarkerDecoration_1.default,
    ...
    UpsellDialog: UpsellDialog_1.default,
