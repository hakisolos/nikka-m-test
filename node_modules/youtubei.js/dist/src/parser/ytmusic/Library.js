...
class Library {
    constructor(response, actions) {
        ...
        const section_list = __classPrivateFieldGet(this, _Library_page, "f").contents_memo.getType(SectionList_1.default).first();
        this.header = (_a = section_list === null || section_list === void 0 ? void 0 : section_list.header) === null || _a === void 0 ? void 0 : _a.item().as(MusicSideAlignedItem_1.default);
        this.contents = (_b = section_list === null || section_list === void 0 ? void 0 : section_list.contents) === null || _b === void 0 ? void 0 : _b.as(Grid_1.default, MusicShelf_1.default);
        __classPrivateFieldSet(this, _Library_continuation, (_d = (_c = this.contents) === null || _c === void 0 ? void 0 : _c.find((list) => list.continuation)) === null || _d === void 0 ? void 0 : _d.continuation, "f");
    }
    /**
    ...
    applySort(sort_by) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof sort_by === 'string') {
                ...
                if (!target_item)
                    throw new Utils_1.InnertubeError(`Sort option "${sort_by}" not found`, { available_filters: options.map((item) => item.title) });
            }
            else if (sort_by instanceof MusicMultiSelectMenuItem_1.default) {
                target_item = sort_by;
            }
            if (!target_item)
                throw new Utils_1.InnertubeError('Invalid sort option');
            ...
            if (!cmd)
                throw new Utils_1.InnertubeError('Failed to find sort option command');
            ...
            const previously_selected_item = (_g = __classPrivateFieldGet(this, _Library_page, "f").contents_memo.getType(MusicMultiSelectMenuItem_1.default)) === null || _g === void 0 ? void 0 : _g.find((item) => item.selected);
            if (previously_selected_item)
                previously_selected_item.selected = false;
            target_item.selected = true;
            this.contents = (_j = (_h = response.continuation_contents) === null || _h === void 0 ? void 0 : _h.as(__1.SectionListContinuation).contents) === null || _j === void 0 ? void 0 : _j.as(Grid_1.default, MusicShelf_1.default);
            return this;
        });
    }
    /**
    ...
    get filters() {
        var _a, _b;
        return ((_b = (_a = __classPrivateFieldGet(this, _Library_page, "f").contents_memo.getType(ChipCloud_1.default)) === null || _a === void 0 ? void 0 : _a.first()) === null || _b === void 0 ? void 0 : _b.chips.map((chip) => chip.text)) || [];
    }
    get page() {
