...
class Album {
    constructor(response, actions) {
        ...
        this.contents = (_c = __classPrivateFieldGet(this, _Album_page, "f").contents_memo.getType(MusicShelf_1.default)) === null || _c === void 0 ? void 0 : _c[0].contents;
        this.sections = __classPrivateFieldGet(this, _Album_page, "f").contents_memo.getType(MusicCarouselShelf_1.default) || [];
    }
    get page() {
