...
class TrackInfo {
    constructor(data, actions, cpn) {
        ...
        if (next) {
            const tabbed_results = (_j = next.contents_memo.getType(WatchNextTabbedResults_1.default)) === null || _j === void 0 ? void 0 : _j[0];
    ...
    getTab(title_or_page_type) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!target_tab)
                throw new Utils_1.InnertubeError(`Tab "${title_or_page_type}" not found`, { available_tabs: this.available_tabs });
            ...
            return page.contents.item().as(SectionList_1.default).contents;
        });
    }
    /**
     * Retrieves up next.
