...
class Playlist {
    ...
    getRelated() {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function* () {
            let section_continuation = (_a = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo.getType(SectionList_1.default)) === null || _a === void 0 ? void 0 : _a[0].continuation;
            while (section_continuation) {
                ...
                const related = (_d = sections === null || sections === void 0 ? void 0 : sections.matchCondition((section) => section.is(MusicCarouselShelf_1.default))) === null || _d === void 0 ? void 0 : _d.as(MusicCarouselShelf_1.default);
                if (related)
                    return related;
                section_continuation = section_list === null || section_list === void 0 ? void 0 : section_list.continuation;
            }
            throw new Utils_1.InnertubeError('Target section not found.');
        });
    }
...
_Playlist_page = new WeakMap(), _Playlist_actions = new WeakMap(), _Playlist_continuation = new WeakMap(), _Playlist_last_fetched_suggestions = new WeakMap(), _Playlist_suggestions_continuation = new WeakMap(), _Playlist_instances = new WeakSet(), _Playlist_fetchSuggestions = function _Playlist_fetchSuggestions() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (continuation) {
            ...
            const sections = (_c = section_list === null || section_list === void 0 ? void 0 : section_list.contents) === null || _c === void 0 ? void 0 : _c.as(MusicCarouselShelf_1.default, MusicShelf_1.default);
            const suggestions = (_d = sections === null || sections === void 0 ? void 0 : sections.matchCondition((section) => section.is(MusicShelf_1.default))) === null || _d === void 0 ? void 0 : _d.as(MusicShelf_1.default);
            return {
