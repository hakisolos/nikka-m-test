...
class Explore {
    constructor(response) {
        ...
        this.top_buttons = ((_b = section_list.contents.firstOfType(Grid_1.default)) === null || _b === void 0 ? void 0 : _b.items.as(MusicNavigationButton_1.default)) || [];
        this.sections = section_list.contents.filterType(MusicCarouselShelf_1.default);
    }
    get page() {
