...
var _LiveChat_instances, _LiveChat_actions, _LiveChat_video_id, _LiveChat_channel_id, _LiveChat_continuation, _LiveChat_mcontinuation, _LiveChat_pollLivechat, _LiveChat_emitSmoothedActions, _LiveChat_pollMetadata, _LiveChat_wait;
...
class LiveChat extends EventEmitterLike_1.default {
    ...
    sendMessage(text) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield __classPrivateFieldGet(this, _LiveChat_actions, "f").execute('/live_chat/send_message', {
                params: index_2.default.encodeMessageParams(__classPrivateFieldGet(this, _LiveChat_channel_id, "f"), __classPrivateFieldGet(this, _LiveChat_video_id, "f")),
    ...
    applyFilter(filter) {
        ...
        if (!this.initial_info)
            throw new Utils_1.InnertubeError('Cannot apply filter before initial info is retrieved.');
...
_LiveChat_actions = new WeakMap(), _LiveChat_video_id = new WeakMap(), _LiveChat_channel_id = new WeakMap(), _LiveChat_continuation = new WeakMap(), _LiveChat_mcontinuation = new WeakMap(), _LiveChat_instances = new WeakSet(), _LiveChat_pollLivechat = function _LiveChat_pollLivechat() {
    (() => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            this.emit('error', new Utils_1.InnertubeError('Failed to poll livechat, retrying...', err));
    ...
    (() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            this.emit('error', new Utils_1.InnertubeError('Failed to poll live metadata, retrying...', err));
            yield __classPrivateFieldGet(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2000);
            if (this.running)
                __classPrivateFieldGet(this, _LiveChat_instances, "m", _LiveChat_pollMetadata).call(this);
        }
