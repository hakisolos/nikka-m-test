...
class AccountInfo {
    constructor(response) {
        ...
        const account_section_list = (_a = __classPrivateFieldGet(this, _AccountInfo_page, "f").contents.array().as(AccountSectionList_1.default)) === null || _a === void 0 ? void 0 : _a[0];
        if (!account_section_list)
            throw new Utils_1.InnertubeError('Account section list not found');
