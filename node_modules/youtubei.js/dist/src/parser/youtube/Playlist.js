...
class Playlist extends Feed_1.default {
    constructor(actions, data, already_parsed = false) {
        ...
        const header = this.memo.getType(PlaylistHeader_1.default).first();
        const primary_info = this.memo.getType(PlaylistSidebarPrimaryInfo_1.default).first();
        const secondary_info = this.memo.getType(PlaylistSidebarSecondaryInfo_1.default).first();
        ...
        this.info = Object.assign(Object.assign({}, this.page.metadata.item().as(PlaylistMetadata_1.default)), {
            author: (_a = secondary_info === null || secondary_info === void 0 ? void 0 : secondary_info.owner.item().as(VideoOwner_1.default).author) !== null && _a !== void 0 ? _a : header === null || header === void 0 ? void 0 : header.author,
            thumbnails: primary_info === null || primary_info === void 0 ? void 0 : primary_info.thumbnail_renderer.item().as(PlaylistVideoThumbnail_1.default, PlaylistCustomThumbnail_1.default).thumbnail,
        ...
        this.messages = this.memo.getType(Message_1.default);
    }
    get items() {
        return this.videos;
    }
