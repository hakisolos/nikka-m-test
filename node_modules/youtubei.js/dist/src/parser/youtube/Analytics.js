...
class Analytics {
    constructor(response) {
        ...
        this.sections = (_a = __classPrivateFieldGet(this, _Analytics_page, "f").contents_memo) === null || _a === void 0 ? void 0 : _a.getType(Element_1.default).map((el) => { var _a; return (_a = el.model) === null || _a === void 0 ? void 0 : _a.item(); });
    }
    get page() {
