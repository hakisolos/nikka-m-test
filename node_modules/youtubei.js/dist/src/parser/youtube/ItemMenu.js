    ...
    selectItem(item) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (item instanceof Button_1.default) {
                if (!item.endpoint)
                    throw new Utils_1.InnertubeError('Item does not have an endpoint.');
                ...
                if (!button || !button.is(MenuServiceItem_1.default))
                    throw new Utils_1.InnertubeError(`Button "${item}" not found.`);
                endpoint = button.endpoint;
            }
            if (!endpoint)
                throw new Utils_1.InnertubeError('Target button does not have an endpoint.');
