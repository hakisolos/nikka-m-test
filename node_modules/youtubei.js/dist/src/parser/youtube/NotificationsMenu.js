...
class NotificationsMenu {
    constructor(actions, response) {
        ...
        this.header = (_a = __classPrivateFieldGet(this, _NotificationsMenu_page, "f").actions_memo.getType(SimpleMenuHeader_1.default)) === null || _a === void 0 ? void 0 : _a[0];
        this.contents = __classPrivateFieldGet(this, _NotificationsMenu_page, "f").actions_memo.getType(Notification_1.default);
    }
    getContinuation() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const continuation = (_a = __classPrivateFieldGet(this, _NotificationsMenu_page, "f").actions_memo.getType(ContinuationItem_1.default)) === null || _a === void 0 ? void 0 : _a[0];
            if (!continuation)
