...
class Comments {
    constructor(actions, data, already_parsed = false) {
        ...
        this.header = (_a = header_node === null || header_node === void 0 ? void 0 : header_node.contents) === null || _a === void 0 ? void 0 : _a.firstOfType(CommentsHeader_1.default);
        const threads = ((_b = body_node === null || body_node === void 0 ? void 0 : body_node.contents) === null || _b === void 0 ? void 0 : _b.filterType(CommentThread_1.default)) || [];
        this.contents = (0, helpers_1.observe)(threads.map((thread) => {
            var _a;
        ...
        __classPrivateFieldSet(this, _Comments_continuation, (_c = body_node === null || body_node === void 0 ? void 0 : body_node.contents) === null || _c === void 0 ? void 0 : _c.firstOfType(ContinuationItem_1.default), "f");
    }
    /**
    ...
    applySort(sort) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.header)
                throw new Utils_1.InnertubeError('Page header is missing. Cannot apply sort option.');
            let button;
    ...
    createComment(text) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const button = (_a = this.header.create_renderer) === null || _a === void 0 ? void 0 : _a.as(CommentSimplebox_1.default).submit_button;
            if (!button)
                throw new Utils_1.InnertubeError('Could not find target button. You are probably not logged in.');
            if (!button.endpoint)
                throw new Utils_1.InnertubeError('Button does not have an endpoint.');
