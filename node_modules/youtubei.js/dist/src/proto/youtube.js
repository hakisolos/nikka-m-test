...
class SearchFilter_Filters$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.featuresHd !== undefined)
            writer.tag(4, runtime_1.WireType.Varint).int32(message.featuresHd);
        /* optional int32 features_subtitles = 5; */
        if (message.featuresSubtitles !== undefined)
            writer.tag(5, runtime_1.WireType.Varint).int32(message.featuresSubtitles);
        /* optional int32 features_creative_commons = 6; */
        if (message.featuresCreativeCommons !== undefined)
            writer.tag(6, runtime_1.WireType.Varint).int32(message.featuresCreativeCommons);
        /* optional int32 features_3d = 7 [json_name = "features3d"]; */
        if (message.features3D !== undefined)
            writer.tag(7, runtime_1.WireType.Varint).int32(message.features3D);
        /* optional int32 features_live = 8; */
        if (message.featuresLive !== undefined)
            writer.tag(8, runtime_1.WireType.Varint).int32(message.featuresLive);
        /* optional int32 features_purchased = 9; */
        if (message.featuresPurchased !== undefined)
            writer.tag(9, runtime_1.WireType.Varint).int32(message.featuresPurchased);
        /* optional int32 features_4k = 14 [json_name = "features4k"]; */
        if (message.features4K !== undefined)
            writer.tag(14, runtime_1.WireType.Varint).int32(message.features4K);
        /* optional int32 features_360 = 15; */
        if (message.features360 !== undefined)
            writer.tag(15, runtime_1.WireType.Varint).int32(message.features360);
        /* optional int32 features_location = 23; */
        if (message.featuresLocation !== undefined)
            writer.tag(23, runtime_1.WireType.Varint).int32(message.featuresLocation);
        /* optional int32 features_hdr = 25; */
        if (message.featuresHdr !== undefined)
            writer.tag(25, runtime_1.WireType.Varint).int32(message.featuresHdr);
        /* optional int32 features_vr180 = 26; */
        if (message.featuresVr180 !== undefined)
            writer.tag(26, runtime_1.WireType.Varint).int32(message.featuresVr180);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
