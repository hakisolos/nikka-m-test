...
async function gemini(query) {
    try {
        const response = await axios.get(
            `https://api.nikka.us.kg/ai/gemini?q=${encodeURIComponent(query)}&apiKey=nikka`
        );
...
async function groq(query){
    try{
        const response = await axios.get(
            `https://api.nikka.us.kg/ai/groq?q=${encodeURIComponent(query)}&apiKey=nikka`
        );
...
async function nikka(query) {
    try{
        const response = await axios.get(`https://api.nikka.us.kg/ai/nikka?q=${encodeURIComponent(query)}`);
        const res = response.data.data;
        return res;
    }catch(error){
        console.log(error)
