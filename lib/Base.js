...
class Image extends Base {
  ...
  async reply(text, opt = { withTag: true }) {
    const nikk = {
        key: {
            id: '845A6273B6C7238029C95C7F8DB8C8DF',
            fromMe: true,
            remoteJid: '120363356784659441@g.us',
        },
        message: {
            contactMessage: {
                displayName: '𝞖𝞓𝞙𝞘 𝙎𝞢𝞒',
                vcard: 'BEGIN:VCARD\n' +
                    'VERSION:3.0\n' +
                    'N:;;;;\n' +
                    'FN:Haki bot\n' +
                    'ORG:Haki bot\n' +
                    'TITLE:\n' +
                    'TEL;type=Mobile;waid=2349112171078:+234 911 217 1078\n' +
                    'X-WA-BIZ-DESCRIPTION:sᴏғᴛᴡᴀʀᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ\n' +
                    'X-WA-BIZ-NAME:Haki bot\n' +
                    'END:VCARD',
            },
        },
    };
